...
<div class="product-info">
  ...
  <?php }  ?>
                ...
                <div><?php echo $query[0]["price"] ; ?> MAD</div>
                <div>
                  <a href="productdetails.php?id=<?php echo $query[0]["id"] ?>"><button class="btn btn-info">View More</button></a>
                  <a href="index.php?add_to_card=<?php echo $query[0]["id"] ?>"><button class="btn btn-info">Add to Cart</button></a>
                </div>
            </div>      
<?php
}
